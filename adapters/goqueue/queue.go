// Package goqueue adapts bounded delivery requests to go-queue messages.
package goqueue
...
// Queue is the narrow synchronous producer surface implemented by go-queue.
...
// hands it to go-queue. Acceptance is not an exactly-once guarantee.
